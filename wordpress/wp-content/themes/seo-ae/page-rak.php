...
$schema_org = [
	...
	'areaServed' => [
		'Ras Al Khaimah','RAK City','Al Hamra','Mina Al Arab','Al Marjan Island',
		'RAK Free Trade Zone','Al Nakheel','Al Dhait','Khuzam',
	],
	'priceRange'   => '$$$$',
...
$city_faqs = [
	[
		'question' => 'How much do SEO services cost in Ras Al Khaimah?',
		'answer'   => 'RAK SEO retainers typically range from AED 2,000/month for local SME campaigns to AED 18,000+/month for tourism, hospitality, and manufacturing enterprise programmes. SearchEngineOptimization.ae provides transparent, fixed monthly pricing with no hidden fees and no lock-in contracts. We deliver a custom quote after a free SEO audit of your site.',
	],
	[
	...
	[
		...
		'answer'   => 'Yes. Bilingual Arabic and English SEO is a core offering. RAK has a strong Arabic-speaking population with significant local Arabic search volumes. We conduct Arabic keyword research, produce native-quality Arabic content, and implement hreflang for bilingual sites.',
	],
	[
		'question' => 'What industries do you serve in Ras Al Khaimah?',
		'answer'   => 'We serve all major RAK industries: tourism and hospitality, real estate and property development, manufacturing and industrial, ceramics and construction materials, healthcare, education, legal services, finance, retail, logistics, automotive, and SaaS and technology. RAK\'s growing tourism sector has specific seasonal SEO requirements we are experienced in managing.',
	],
	[
		'question' => 'Do you run Google Ads (PPC) campaigns for RAK businesses?',
		'answer'   => 'Yes. We offer fully managed Google Ads and Meta Ads campaigns targeted at RAK audiences and Northern Emirates buyer intent. For RAK tourism and hospitality businesses, we also run international-audience campaigns targeting key source markets including UK, Germany, Russia, and India.',
	],
	[
	...
	[
		...
		'answer'   => 'We are a UAE-specialist agency, not a global generalist. We have served 345+ UAE businesses across every major sector, deliver full bilingual Arabic and English SEO, and have specific experience in RAK\'s tourism, hospitality, and manufacturing sectors. No lock-in contracts, transparent pricing, and a proven track record of measurable organic growth.',
	],
];
...
<section class="service-hero bg-dark" style="padding:5rem 0 4rem;">
	<div class="container">
		...
		<nav class="breadcrumbs" aria-label="Breadcrumb">
			...
			<span>/</span>
			<span>SEO Agency Ras Al Khaimah</span>
		</nav>
		...
		<div class="service-hero__inner" style="display:grid;grid-template-columns:1.3fr 0.7fr;gap:3.5rem;align-items:start;margin-top:2rem;">
			...
			<!-- Left: Copy -->
			<div>
				<?php seoae_section_label('RAK Local SEO'); ?>
			...
			<div style="display:flex;flex-direction:column;gap:.875rem;">
				<div style="background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.12);border-radius:16px;padding:1.5rem;text-align:center;">
					<div style="font-size:2.4rem;font-weight:900;color:var(--color-primary,#16B1D4);line-height:1;">900K+</div>
					<div style="font-size:.7rem;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:rgba(255,255,255,.45);margin-top:.35rem;">Monthly RAK Google Searches</div>
				</div>
				<div style="display:grid;grid-template-columns:1fr 1fr;gap:.75rem;">
					<div style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:12px;padding:1.1rem;text-align:center;">
						<div style="font-size:1.5rem;font-weight:800;color:#fff;">300%</div>
					...
					<div style="background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);border-radius:12px;padding:1.1rem;text-align:center;">
						<div style="font-size:1.5rem;font-weight:800;color:var(--color-primary,#16B1D4);">75 Days</div>
		...
		<div class="why-grid" style="margin-top:2.5rem;">
			...
			$points = [
				...
				[
					...
					'title' => 'Free Zone B2B SEO',
					'desc'  => 'RAKFTZ hosts thousands of international businesses. We build B2B SEO strategies that help free zone companies rank for UAE, GCC, and international buyer searches.',
				],
				[
					...
					'desc'  => 'Full bilingual optimisation for RAK\'s dual-language audience. Arabic SEO captures the local residential market while English SEO attracts international tourists and investors.',
				],
				[
					...
					'desc'  => 'RAK\'s growing tourism profile attracts visitors from UK, Germany, Russia, India, and China. We build multilingual SEO and international PPC strategies to capture these source markets.',
				],
				[
		...
		<div class="services-grid" style="margin-top:2.5rem;">
			...
			$svcs = [
				...
				[
					...
					'desc'  => 'Get your RAK business featured in Google AI Overviews, ChatGPT, Perplexity, and Gemini.',
				],
				[
					...
					'title' => 'PPC Management RAK',
					'url'   => '/services/ppc-management/',
					'desc'  => 'Google Ads campaigns targeted at RAK and international tourism audiences.',
				],
				[
					...
					'desc'  => 'Build brand authority and engagement across RAK\'s Instagram, LinkedIn, and TikTok audiences.',
				],
				[
					...
					'title' => 'Web Design RAK',
					'url'   => '/services/web-design/',
					'desc'  => 'High-converting, fast-loading websites designed for RAK businesses and international visitors.',
				],
				[
...
<section class="section bg-white">
	<div class="container">
		<div class="section-header section-header--center">
			...
			<h2>SEO Services Across All RAK Areas</h2>
			<p class="section-header__desc" style="max-width:540px;margin-left:auto;margin-right:auto;">
				We create area-specific SEO strategies so your business ranks for the exact location searches your customers make across Ras Al Khaimah.
			</p>
		</div>
		<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:1rem;margin-top:2.5rem;">
			<?php
			$districts = [
				'RAK City Centre','Al Hamra Village','Al Marjan Island','Mina Al Arab',
				'Al Nakheel','Khuzam','Al Dhait','Al Mairid',
				'RAKFTZ','Wynn Al Marjan','Jebel Jais','Al Rams',
			];
...
<section class="section" style="background:#f0f4f8;">
	<div class="container">
		<div class="section-header section-header--center">
			...
			<h2>Ras Al Khaimah Industries We Serve</h2>
		</div>
...
<?php
seoae_cta_dark(
	"Ready to Dominate RAK's Search Results?",
	'Join 345+ UAE businesses that trust SearchEngineOptimization.ae to drive measurable organic growth. Get your free Ras Al Khaimah SEO audit today.',
	'Get Free RAK SEO Audit',
	home_url('/contact/'),
	'Email Us',
	'mailto:' . seoae_email()
);
